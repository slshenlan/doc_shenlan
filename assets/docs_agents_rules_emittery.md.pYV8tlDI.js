import{_ as n,o as a,c as i,ak as l}from"./chunks/framework.HyOigXlE.js";const b=JSON.parse('{"title":"emittery","description":"","frontmatter":{},"headers":[],"relativePath":"docs/agents/rules/emittery.md","filePath":"docs/agents/rules/emittery.md","lastUpdated":1789614898000}'),p={name:"docs/agents/rules/emittery.md"};function e(r,s,h,k,t,E){return a(),i("div",null,[...s[0]||(s[0]=[l(`<h1 id="emittery" tabindex="-1">emittery <a class="header-anchor" href="#emittery" aria-label="Permalink to “emittery”">​</a></h1><div class="language-markdown line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">markdown</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-light-font-weight:bold;--shiki-dark:#79B8FF;--shiki-dark-font-weight:bold;"># 事件通信规范</span></span>
