import{_ as n,o as a,c as p,ak as l}from"./chunks/framework.HyOigXlE.js";const m=JSON.parse('{"title":"Docker 安装 redis","description":"","frontmatter":{},"headers":[],"relativePath":"docs/server/database/redis/docker.md","filePath":"docs/server/database/redis/docker.md","lastUpdated":1790232042000}'),e={name:"docs/server/database/redis/docker.md"};function i(r,s,c,b,t,h){return a(),p("div",null,[...s[0]||(s[0]=[l(`<h1 id="docker-安装-redis" tabindex="-1">Docker 安装 redis <a class="header-anchor" href="#docker-安装-redis" aria-label="Permalink to “Docker 安装 redis”">​</a></h1><h2 id="文件夹结构" tabindex="-1">文件夹结构 <a class="header-anchor" href="#文件夹结构" aria-label="Permalink to “文件夹结构”">​</a></h2><div class="language-txt line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>redis/</span></span>
