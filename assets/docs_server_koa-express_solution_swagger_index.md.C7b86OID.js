import{_ as n,o as a,c as i,ak as p,aD as l}from"./chunks/framework.HyOigXlE.js";const A=JSON.parse('{"title":"swagger 文档","description":"","frontmatter":{},"headers":[],"relativePath":"docs/server/koa-express/solution/swagger/index.md","filePath":"docs/server/koa-express/solution/swagger/index.md","lastUpdated":1790232042000}'),e={name:"docs/server/koa-express/solution/swagger/index.md"};function r(h,s,t,k,c,b){return a(),i("div",null,[...s[0]||(s[0]=[p('<h1 id="swagger-文档" tabindex="-1">swagger 文档 <a class="header-anchor" href="#swagger-文档" aria-label="Permalink to “swagger 文档”">​</a></h1><h2 id="图例" tabindex="-1">图例 <a class="header-anchor" href="#图例" aria-label="Permalink to “图例”">​</a></h2><p><img src="'+l+`" alt="图例"></p><h2 id="示例" tabindex="-1">示例 <a class="header-anchor" href="#示例" aria-label="Permalink to “示例”">​</a></h2><div class="vp-code-group"><div class="tabs"><input type="radio" name="group-12" id="tab-13" checked><label data-title="get" for="tab-13">get</label><input type="radio" name="group-12" id="tab-14"><label data-title="post" for="tab-14">post</label><input type="radio" name="group-12" id="tab-15"><label data-title="额外标记" for="tab-15">额外标记</label></div><div class="blocks"><div class="language-ts active line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/**</span></span>
