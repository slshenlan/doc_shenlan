import{_ as n,o as a,c as p,ak as l}from"./chunks/framework.HyOigXlE.js";const u=JSON.parse('{"title":"配置示例","description":"","frontmatter":{},"headers":[],"relativePath":"docs/server/nginx/config.md","filePath":"docs/server/nginx/config.md","lastUpdated":1790232042000}'),e={name:"docs/server/nginx/config.md"};function i(r,s,c,b,t,m){return a(),p("div",null,[...s[0]||(s[0]=[l(`<h1 id="配置示例" tabindex="-1">配置示例 <a class="header-anchor" href="#配置示例" aria-label="Permalink to “配置示例”">​</a></h1><h2 id="文件夹结构" tabindex="-1">文件夹结构 <a class="header-anchor" href="#文件夹结构" aria-label="Permalink to “文件夹结构”">​</a></h2><div class="language-txt line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span>nginx/</span></span>
